إليك ملف README.rst باللغة العربية، معدلاً بالكامل ليتناسب مع نسختك الخاصة بفريق AST، مع إضافة قسم خاص يوضح المميزات الحصرية التي أضفناها (الذكاء الاصطناعي في التصنيف والبحث).
ملاحظة: قمت بتعديل روابط التثبيت لتشير إلى مستودعك الخاص (قم باستبدال your-username باسم حسابك الحقيقي).
------------------------------
.. code-block:: rst
